...
public class SnowMan extends JComponent implements Mover
{
    ...
    */
   public SnowMan( JPanel jp, JFrame frame, int x, int y )
   {
//      _parent  = frame.getContentPane();   
      _parent = jp;
      _components = new Vector<GShape>();
      
      makeFace( frame, x, y );   // create the face      
      makeHat(  frame, x, y );   // create the hat and its brim  
      makeBody( frame, x, y );   // create the body
      makeArms( frame, x, y );   // create some arms
      makeHead( frame, x, y );   // create the head
     
      super.setSize( _xMax - _xLoc + 3, _yMax - _yLoc + 3 );
      setLocation( _xLoc, _yLoc );
   }
   //++++++++++++++++++++++ component makeing methods ++++++++++++++++++++
   //------------------ makeFace ---------------------------------------
   private void makeFace( Container parent, int x, int y )
   {
   ...
   //------------------ makeHat ---------------------------------------
   private void makeHat( Container parent, int x, int y )
   {
   ...
   //------------------ makeBody ---------------------------------------
   private void makeBody( Container parent, int x, int y )
   {
   ...
   //------------------ makeArms ---------------------------------------
   private void makeArms( Container parent, int x, int y )
   {
   ...
   //------------------ makeHead ---------------------------------------
   private void makeHead( Container parent, int x, int y )
   {
   ...
   {
     return _parent.getX() + _parent.getWidth() - this.getWidth();
   }
   /**
   ...
   {
      return _parent.getY() + _parent.getHeight() - this.getHeight();
   }
 }
