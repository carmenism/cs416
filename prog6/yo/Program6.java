...
public class Program6 extends JFrame implements ActionListener 
{
   ...
   public Program6( String title, String[] args )    
   {
      ...
      createBottomGrid();
      JLabel top = new JLabel("Please enter expressions with spaces even " +
                              "between numbers and parenthesis. x: " +
    ...
    *    Creates the 3 by 3 for the text fields and buttons.
    */
   private void createBottomGrid()
   {
