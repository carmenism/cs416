...
public class GLine extends GShape
{
    ...
    */
   public GLine( JFrame frame, Color aColor )
   { 
      super( frame, aColor );
      setPoints( 0, 0, 10, 10 );
   }
    ...
    */
   public GLine( JFrame frame, int x1, int y1, int x2, int y2 )
   {
      super( frame, Color.RED );
   ...
   public void paintComponent( java.awt.Graphics brush )
   {
      ...
      brush2.setStroke( new BasicStroke( getLineWidth() ));
