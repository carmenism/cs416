...
public class ControlPanel extends JPanel 
{
   ...
   public ControlPanel( Component parent, TreeApp app ) 
   {
      ...
      buttonRow.add( new QuitButton() );
      
      _nextDataLabel = new JLabel( "NextData: " );
      buttonRow.add( _nextDataLabel );
            
      add( buttonRow );
   }
   //--------------------- setNextDataLabel( String ) ----------------------
   /**
    * update the label field indicating the next data item to be added
    */
   public void setNextDataLabel( String newText )
   {
      _nextDataLabel.setText( "NextData: " + newText );
   }
   //+++++++++++++++++++++++ SeedSpinner class ++++++++++++++++++++
   /**
