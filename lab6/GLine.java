/**
 * GLine.java -- a convenience class for simplifying access to awt graphics
...
public class GLine extends GShape
{
    ...
    */
   public GLine( Container parent, Color aColor )
   { 
      super( parent, aColor );
      setPoints( 0, 0, 10, 10 );
   }
    ...
    */
   public GLine( JFrame parent, int x1, int y1, int x2, int y2 )
   {
      super( parent, Color.RED );
      setPoints( x1, y1, x2, y2 );
      System.out.println( "GLine constructor" );
   }   
   ...
   public void paintComponent( java.awt.Graphics brush )
   {
      ...
      // accommodate a vertical line of some line width.
      //   
      brush2.setClip( 0, 0, w + lw, h + lw );
