 ...
 * previous assignments. The goal is distribute mostddvi  of the major 
...
public class Lab23 extends JFrame
{
   //---------------------- instance variables ----------------------   
   //--------------------------- constructor -----------------------
   public Lab23( String title, String[] args ) 
   {      
      super( title );
   ...
   {
      Lab23 l = new Lab23( "Regular Expression Simple Exploration Tool", args );
   }
}